      ...
      <div className="p-5 mt-3 mx-auto md:mt-5 md:mx-10 lg:mx-16">
        ...
        <div className="mx-auto flex lg:flex-row flex-col items-center justify-center">
          ...
          <div className="lg:w-1/2 justify-center lg:p-5 xl:p-7 md:p-5 flex flex-col items-center text-justify">
            ...
            >
              A highly skilled Senior AI Developer with extensive experience
              in advanced image generation technologies and frameworks,
              leveraging a strong background in deep learning and computer
              vision. Proficient in creating and integrating cutting-edge image
              generation models, including GANs (Generative Adversarial
              Networks) and diffusion models. Demonstrated ability to
              enhance user experiences through the development of
              intelligent image generation solutions that align with specific
              business objectives.
            </p>
            <div
              data-aos="zoom-in"
